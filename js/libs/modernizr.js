...
Modernizr.addTest('getusermedia', !!Modernizr.prefixed('getUserMedia', navigator));// Test for `seamless` attribute in iframes.
//
...
// async script
// By Theodoor van Donge
Modernizr.addTest('scriptasync', 'async' in document.createElement('script'));// Navigation Timing (Performance)
